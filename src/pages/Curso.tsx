  ...
  return (
    <div className="container mx-auto px-4 py-6 space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-primary">Instructorado de fitness grupal</h1>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription className="text-white/80">Accede a todo el contenido organizado</CardDescription>
              </div>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription className="text-white/80">PDFs y documentos complementarios</CardDescription>
              </div>
              <ChevronRight className="w-6 h-6" />
            </div>
          </CardHeader>
